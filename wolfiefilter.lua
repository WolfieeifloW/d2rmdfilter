...
return {
    ...
    rules = {
        ...
        { -- Rule 13: Fixing Storage Bag helper info
            code = "Z01",
            prefix = "{purple}------------------\nÿcU(Cube with item to store it)\n",
            location = "onplayer"
        },
        { -- Rule 14: Reminder to pick up Starter's Cube of Endless Convenience so it doesn't get left behind
            code = "y66",
        ...
        -- | RMD NEW ITEMS           |
        -- +-------------------------+
        { -- Rule 15: Notify and medium border for all Codexes
        ...
        { -- Rule 16: Notify and medium border for all Blood Contracts
        ...
        { -- Rule 17: Random RMD items that have gold names (used to match chat color brackets for notify)
        ...
        { -- Rule 18: Random RMD items that have red names (used to match chat color brackets for notify)
            codes = { "hpf", "hpo", "rpl", "rps", "y67" },
            notify = "{purple}RMD Item {red}{link}",
            border = { 174, 0, 255, 255, 3 }
        },
        { -- Rule 19: Random RMD items that have blue names (used to match chat color brackets for notify)
        ...
        { -- Rule 20: Random RMD items that have white names (used to match chat color brackets for notify)
        ...
        { -- Rule 21: Random RMD items that have pink names (used to match chat color brackets for notify)
            codes = { "y33" },
            notify = "{purple}RMD Item {pink}{link}",
            border = { 174, 0, 255, 255, 3 }
        },
        { -- Rule 22: Random RMD items that I'm unsure what color their name is (recoloring them white for now)
        ...
        -- | QUEST ITEMS             |
        -- +-------------------------+
        { -- Rule 23: Notify and medium border all quest items
        ...
        -- | ESSENCES & TOKEN        |
        -- +-------------------------+
        { -- Rule 24: Notify and small border on essences and tokens
        ...
        -- | UBER ITEMS              |
        -- +-------------------------+
        { -- Rule 25: Notify and small border on Uber items
            codes = { "pk1", "pk2", "pk3", "mbr", "dhn", "bey" },
            notify = "{orange}Ubers Item {link}",
            border = { 255, 168, 0, 255, 1 }
        },
        { -- Rule 26: Notify and small border on Standard of Heroes
            code = "std",
        ...
        -- | RUNES                   |
        -- +-------------------------+
        { -- Rule 27: Always give runes a small border (will be overridden by other borders below)
        ...
        { -- Rule 28: Notify until Character Level 25 and small border for Low Runes
            codes = { "r01", "r02", "r03", "r04", "r05", "r06", "r07", "r08", "r09", "r10", "r11" },
            pstat = { index = 12, op = "<=", value = 25 },
            notify = "{green}Low Rune {orange}{link}"
        },
        { -- Rule 29: Notify until Character Level 75 and medium border for Mid Runes
        ...
        -- | MAGIC ITEMS             |
        -- +-------------------------+
        { -- Rule 32: Hide all non-RMD magic items at Character Level 75+ (Magic items can be gambled for crafting)
        ...
        { -- Rule 33: Hide all magic Amulets, Rings, & Quivers at Character Level 75+ (Magic items can be gambled for crafting)
        ...
        -- | TAGS & GENERIC RULES    |
        -- +-------------------------+
        { -- Rule 50: Adding item level to appropriate items (Rings, Amulets, Weapons, Armors, Jewels, and Small/Large/Grand Charms)
            codes = "allitems",
            itype = { 10, 12, 45, 50, 58, 82, 83, 84 },
            location = { "onplayer", "equipped" , "onground", "dropping", "atvendor" },
            suffix = " ({ilvl})"
        },
        { -- Rule 51: Adding [Eth] tag to items
            codes = "allitems",
            ethereal = true,
            suffix = " {gray}[Eth]"
        },
        { -- Rule 52: Adding socket number tag to Ethereal items
            codes = "allitems",
            ethereal = true,
            sockets = "1+",
            prefix = "ÿcI",
        ...
        { -- Rule 53: Adding socket number tag to Non-Ethereal items
            codes = "allitems",
            ethereal = false,
            sockets = "1+",
            suffix = " {gray}[{sockets}]"
        ...
        { -- Rule 54: Adding superscript "1" in front of Normal tier items names
            codes = "allitems",
            rarity = 0,
            itype = { 45, 50 },
        ...
        { -- Rule 55: Adding superscript "2" in front of Exceptional tier items names
            codes = "allitems",
            rarity = 1,
            itype = { 45, 50 },
            location = { "onground", "onplayer", "equipped", "atvendor" },
        ...
        { -- Rule 56: Adding superscript "EB 3" in front of Elite tier items names
        ...
        { -- Rule 57: Adding superscript "LB 3" in front of Elite tier Limit Break items names
        ...
        -- | ITEM HELPER TEXT        |
        -- +-------------------------+
        { -- Rule 58: Scroll of Inifuss
            code = "bks",
            location = "onplayer",
            prefix = "{gold}in Act 1\nTalk to Akara\n"
        },
        { -- Rule 59: Scroll of Inifuss, deciphered
            code = "bkd",
            location = "onplayer",
        ...
        { -- Rule 97: Normal Unique Armor upgrade recipe
            codes = "allitems",
            itype = 50,
            quality = 7,
            rarity = 0,
        ...
        { -- Rule 98: Exceptional Unique Armor upgrade recipe
            codes = "allitems",
            itype = 50,
            quality = 7,
            rarity = 1,
        ...
        { -- Rule 99: Normal Unique Weapon upgrade recipe
        ...
        { -- Rule 100: Exceptional Unique Weapon upgrade recipe
            codes = "allitems",
            itype = 45,
            quality = 7,
            rarity = 1,
        ...
        -- | TESTING                 |
        -- +-------------------------+
        -- { -- Rule 104: For testing, adds a bunch of info to item
        --     codes = "allitems",
