--- Filter Title: WolfieeifloW's Filter v1.1
...
return {
    reload = "WolfieeifloW's Filter v1.1: {green}reloaded",
    rules = {
        -- +-------------------------+
        -- | GOLD                    |
        -- +-------------------------+
        { -- Rule 1: Always hide piles of 25 or less gold
            code = "gld",
            stat = { index = 14, op = "<=", value = 25 },
            area = NOT { "Rogue Encampment", "Lut Gholein", "Kurast Docktown", "The Pandemonium Fortress", "Harrogath" },
            hide = true
        },
        { -- Rule 2: Hide 50 gold and less if Character Level 10+
            code = "gld",
            stat = { index = 14, op = "<=", value = 50 },
            pstat = { index = 12, op = ">=", value = 10 },
            area = NOT { "Rogue Encampment", "Lut Gholein", "Kurast Docktown", "The Pandemonium Fortress", "Harrogath" },
            hide = true
        },
        { -- Rule 3: Hide 200 gold and less if Character Level 20+
            code = "gld",
        ...
        { -- Rule 4: Hide 300 gold and less if Character Level 30+
            code = "gld",
        ...
        { -- Rule 5: Hide 500 gold and less if Character Level 40+
            code = "gld",
            stat = { index = 14, op = "<=", value = 500 },
        ...
        { -- Rule 6: Hide 1000 gold and less if Character Level 50+
            code = "gld",
        ...
        -- | RMD STARTER ITEMS       |
        -- +-------------------------+
        { -- Rule 7: Reminder to pick up Horadric Cube so it doesn't get left behind
            code = "box",
            notify = "{gold}DON'T FORGET ME! {link}",
            border = { 199, 179, 119, 255, 5 }
        },
        { -- Rule 8: Reminder to pick up Town Portal Book so it doesn't get left behind
            code = "tbk",
            name_override = "{blue}Book of Safe Return",
            notify = "{blue}DON'T FORGET ME! {link}",
            border = { 110, 110, 255, 255, 5 }
        },
        { -- Rule 9: Reminder to pick up Identify Book so it doesn't get left behind
            code = "ibk",
            name_override = "{red}Book of Insight",
            notify = "{red}DON'T FORGET ME! {link}",
            border = { 255, 77, 77, 255, 5 }
        },
        { -- Rule 10: Overriding Tome of Town Portal name to the cooler name
            code = "tbk",
            name_override = "{blue}Book of Safe Return",
            location = "onplayer"
        },
        { -- Rule 11: Overriding Tome of Identify name to the cooler name
            code = "ibk",
            name_override = "{red}Book of Insight",
            location = "onplayer"
        },
        { -- Rule 12: Reminder to pick up Key so it doesn't get left behind
            code = "key",
            notify = "{gold}DON'T FORGET ME! {link}",
            border = { 199, 179, 119, 255, 5 }
        },
        { -- Rule 13: Reminder to pick up The Statue of Mythos Soul Tracker so it doesn't get left behind
            codes = { "y01", "y02", "y03", "y04", "y05", "y06", "y07", "y08", "y34", "y35", "y36", "y37", "y38", "y39", "y40" },
            notify = "{gold}DON'T FORGET ME! {link}",
            border = { 199, 179, 119, 255, 5 }
        },
        { -- Rule 14: Reminder to pick up Storage Bag so it doesn't get left behind
            code = "Z01",
            notify = "{gold}DON'T FORGET ME! {link}",
            border = { 199, 179, 119, 255, 5 }
        },
        ...
        -- | MAGIC ITEMS             |
        -- +-------------------------+
        { -- Rule 33: Hide all non-RMD Normal & Exceptional magic items at Character Level 75+ (Magic items can be gambled for crafting)
        ...
        { -- Rule 35: Hide Magic Large Charms (relatively useless)
            code = "cm2",
            quality = "4",
            area = NOT { "Rogue Encampment", "Lut Gholein", "Kurast Docktown", "The Pandemonium Fortress", "Harrogath" },
            hide = true
        ...
        -- | SET ITEMS               |
        -- +-------------------------+
        { -- Rule 36: Notify and small border for all Set items
            codes = "allitems",
            quality = "5",
        ...
        -- | RARE ITEMS              |
        -- +-------------------------+
        { -- Rule 37: Small border on Rare Amulets, Rings, and Jewels
            codes = { "amu", "rin", "jew" },
            quality = "6",
        ...
        -- | UNIQUE ITEMS            |
        -- +-------------------------+
        { -- Rule 38: Notify and small border for all Unique items
            codes = "allitems",
            quality = "7",
        ...
        -- | CRAFTED ITEMS           |
        -- +-------------------------+
        { -- Rule 39: Reminder to pick up Crafted items so they don't get left behind
            codes = "allitems",
            quality = "8",
        ...
        -- | POTIONS                 |
        -- +-------------------------+
        { -- Rule 41: Hides all non-large Potions & Scrolls after Normal Difficulty
        ...
        -- | BASE ITEMS              |
        -- +-------------------------+
        { -- Rule 42: Reminder to pick up Runeword items so they don't get left behind
            codes = "allitems",
            runeword = true,
            notify = "{gray}DON'T FORGET ME! {gold}{link}",
            border = { 199, 179, 119, 255, 3 }
        },
        { -- Rule 43: Hiding Inferior items at Character Level 10+
            codes = "allitems",
            quality = "1",
            runeword = false,
            pstat = { index = 12, op = ">=", value = 10 },
        ...
        { -- Rule 44: Hiding Normal quivers at Character Level 10+
            codes = { "aqv", "cqv" },
            quality = "3-",
            pstat = { index = 12, op = ">=", value = 10 },
            area = NOT { "Rogue Encampment", "Lut Gholein", "Kurast Docktown", "The Pandemonium Fortress", "Harrogath" },
        ...
        { -- Rule 45: Hides all 1 socket Inferior, Normal, and Superior items at Character Level 25+
            codes = "allitems",
            sockets = "1",
            quality = "3-",
            pstat = { index = 12, op = ">=", value = 25 },
        ...
        { -- Rule 46: Hides non-Superior bases that have 0 sockets at Character Level 25+
        ...
        { -- Rule 47: Hides all +0 to Paladin Skill Levels Scepters at Character Level 50+
        ...
        -- | TAGS & GENERIC RULES    |
        -- +-------------------------+
        { -- Rule 48: Adding [Eth] tag to items
            codes = "allitems",
            ethereal = true,
            suffix = " {gray}[Eth]"
        },
        { -- Rule 49: Adding socket number tag to Ethereal items
            codes = "allitems",
            ethereal = true,
            sockets = "1+",
            prefix = "ÿcI",
        ...
        { -- Rule 50: Adding socket number tag to Non-Ethereal items
            codes = "allitems",
            ethereal = false,
            sockets = "1+",
            suffix = " {gray}[{sockets}]"
        ...
        -- | TESTING                 |
        -- +-------------------------+
        -- { -- Rule 51: For testing, adds item code to item name
        --     codes = "allitems",
